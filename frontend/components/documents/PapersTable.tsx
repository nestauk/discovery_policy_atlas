  ...
  const baseColumns: ColumnsType<DataType> = [
    ...
    },
    {
      ...
      render: (_text, record) => {
        ...
        const tooltipContent = getEvidenceCategoryTooltipContent(
          category,
    ...
    },
    {
      ...
      render: (_text, record) => {
        ...
        const tooltip = getEvidenceStrengthTooltipContent(record.evidence_strength_justification)
        return (
          <StarRating
            stars={displayScore}
            size="sm"
    ...
    },
    {
      ...
      render: (text, record) => {
        const tooltip = getImpactScoreTooltipContent(record)
        return (
          <StarRating
