...
class SummaryService:
    ...
    def summarize(
        self, papers_list: list[dict], extraction_fields: list[str] = None
    ) -> str:
        ...
        user_message = "Given the following papers and their extracted fields, write a concise summary focusing on main themes and key information:\n\n{input}"
