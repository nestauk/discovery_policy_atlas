...
**Definition**: A policy synthesis or guidance document is a report whose primary aim is to aggregate, interpret, summarise, and translate existing evidence into actionable insights, guidance or recommendations for policymakers or practitioners, rather than to present new primary empirical findings. Such documents typically:
...
3. Choose the SINGLE BEST-FIT category from the 7 options above
4. Provide a confidence score (0.0-1.0) based on:
...
5. Provide brief reasoning (1-2 sentences) explaining your classification
