...
- **Search**: Query academic and policy papers (MVP version)
...
To deploy the app locally and start developing, see the [installation guide](https://nestauk.github.io/discovery_policy_atlas/setup/installation/).
